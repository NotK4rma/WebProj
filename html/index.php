...
<body>
    ...
    <section>
            ...
            <div class="Animals">
                <div class="four">
                    ...
                    <div class="img-container"><img src="../img/cat1.png" alt=""><h3>cat</h3><div class="line"></div></div>
                    <div class="img-container"><img src="../img/kalleb2.png" alt=""><h3>dog</h3><div class="line"></div></div>
                    <div class="img-container"><img src="../img/others.png" alt=""><h3>other</h3><div class="line"></div></div>
                    <div class="img-container" ><img src="../img/shelter.png" alt="" ><h3>shelter</h3><div class="line"></div></div>
                </div>
            </div>
    </section>
    <section class="available">
        ...
        <div class="section2">
            ...
            <h1> Pets Avaible for Adoption </h1>
            <div class="grid-container">
                
                <div class="img-container"><img src="../img/adoptionCats.jpg" alt=""><h3>tulip & Tati</h3><div class="line"></div></div>
                <div class="img-container"><img src="../img/adoptionRabit.jpg" alt=""><h3>jerrero</h3><div class="line"></div></div>
                <div class="img-container"><img src="../img/adoptionPit2.jpeg" alt=""><h3>jack</h3><div class="line"></div></div>   
                <div class="img-container" id="petsAdpt"><img src="../img/pawimg5.jpg" alt=""><h3>more</h3><div class="line"></div></div>           
            </div>
         </div>
    </section>
    <section class="trivia">
        ...
        <div class="article-space">
            ...
            <div class="section_article_title">
    ...
    <script src="../js/dogAge.js"></script>
    <footer>
            <div class="tunisia">
