...
<body>
    ...
    <main class="application-details-container">
        ...
        // Get application details with pet and user information
            ...
            <div class='application-content'>
                <div class='pet-details-card'>
                    ...
                    <div class='pet-info'>
                        ...
                        <a href='pet-details.php?id=$pet_id' class='view-pet-btn'>View Full Pet Details</a>
                    </div>
                </div>
                ...
                <div class='application-info-card'>
                    ...
                    // Display specific messages based on status
                    if($status == 'pending') {
                        echo "
